...
class PHPMailer {
	...
	public function setFrom($address, $name = '', $auto = true) {
		...
		$pos = strrpos ( $address, '@' );
		if (false === $pos or (! $this->has8bitChars ( substr ( $address, ++ $pos ) ) or ! $this->idnSupported ()) and ! static::validateAddress ( $address )) {
	...
	public function punyencodeAddress($address) {
		...
		$pos = strrpos ( $address, '@' );
		if ($this->idnSupported () and ! empty ( $this->CharSet ) and false !== $pos) {
	...
	public function encodeString($str, $encoding = 'base64') {
		...
		switch (strtolower ( $encoding )) {
			case 'base64' :
				$encoded = chunk_split ( base64_encode ( $str ), static::STD_LINE_LENGTH - strlen ( static::$LE ), static::$LE );
				break;
			case '7bit' :
			case '8bit' :
